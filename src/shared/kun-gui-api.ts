...
export type KunGuiApi = {
  ...
  listClaudePlugins: () => Promise<{ plugins: Array<{ id: string; name: string; version: string; description?: string; author?: string; homepage?: string; license?: string; sourceRoot?: string; marketplaceName?: string; commandCount: number; skillCount: number }> }>
  installClaudePlugin: () => Promise<{ canceled: true } | { canceled: false; ok: true; plugin: { id: string; name: string; version: string; description?: string; author?: string; homepage?: string; license?: string; sourceRoot?: string; commandCount: number; skillCount: number } } | { canceled: false; ok: false; errors: string[] }>
  uninstallClaudePlugin: (id: string) => Promise<ClaudePluginUninstallIpcResult>
  fetchClaudePluginMarketplace: () => Promise<{ plugins: Array<{ name: string; version: string; description?: string; author?: string; license?: string; homepage?: string; repository?: string; installName: string; installKind?: 'npm' | 'git' }> }>
  installClaudePluginFromNpm: (installName: string) => Promise<{ ok: true; plugin: { id: string; name: string; version: string; description?: string; author?: string; homepage?: string; license?: string; sourceRoot?: string; commandCount: number; skillCount: number } } | { ok: false; errors: string[] }>
  installClaudePluginFromGitHub: (repoUrl: string) => Promise<{ ok: true; plugin: { id: string; name: string; version: string; description?: string; author?: string; homepage?: string; license?: string; sourceRoot?: string; commandCount: number; skillCount: number } } | { ok: false; errors: string[] }>
  exportPptx: (input: { outputPath: string; title?: string; author?: string; template?: 'tech' | 'gov' | 'warm' | 'minimal'; slides: Array<{ title?: string; subtitle?: string; body?: string[]; bulletPoints?: string[]; imagePath?: string; table?: { headers: string[]; rows: string[][] } }> }) => Promise<{ ok: boolean; path?: string; slideCount?: number; error?: string }>
  exportDocx: (input: { outputPath: string; title?: string; author?: string; template?: 'report' | 'proposal' | 'minutes' | 'letter'; sections: Array<{ heading?: string; body?: string[]; table?: { headers: string[]; rows: string[][] }; indent?: number }> }) => Promise<{ ok: boolean; path?: string; sectionCount?: number; error?: string }>
